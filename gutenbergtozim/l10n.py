...
l10n_strings = {
    ...
    "locales": {
        "en": {
            ...
            "sort-popularity": {
                "textContent": "Sort books by popularity"
            },
            "sort-title": {
            ...
            "about-4": {
                "textContent": "We carry high quality ebooks"
            },
            "about-5": {
        ...
        "fr": {
            ...
            "sort-popularity": {
                "textContent": "Trier les livres par popularité"
            },
            "sort-title": {
            ...
            "no-data": {
                "textContent": "Pas de données disponibles"
            },
            "prev": {
            ...
            "other-languages": {
                "textContent": "Autres langues"
            },
            "author-anonymous": {
                "textContent": "Anonyme"
            },
            "author-various": {
                "textContent": "Plusieurs"
            },
            "license": {
                "textContent": "Licence"
            },
            ...
            "nb-downloads[one]": {
                "textContent": "1 téléchargement au cours des "
                               "30 derniers jours."
            },
            "nb-downloads[other]": {
        ...
        "it": {
            ...
            "cover": {
                "textContent": "(copertina)"
            },
            "filter": {
                "textContent": "Filtro:"
            },
            "popularity": {
                "textContent": "Popolarità"
            },
            "sort": {
                "textContent": "Ordina:"
            },
            "sort-popularity": {
                "textContent": "Ordina libri per popolarità"
            },
            "sort-title": {
            ...
            "no-data": {
                "textContent": "Nessun dato disponibile nella tabella"
            },
            "prev": {
                "textContent": "Precedente"
            },
            "next": {
                "textContent": "Successivo"
            },
            "language": {
                "textContent": "Linguaggio"
            },
            "any-languages": {
                "textContent": "Scegli il CatalogoChoose the Catalog"
            },
            "main-languages": {
                "textContent": "Lingue Principali"
            },
            "other-languages": {
                "textContent": "Altre lingue"
            },
            "author-anonymous": {
                "textContent": "Anonimo"
            },
            ...
            "license-pd": {
                "textContent": "Di pubblico dominio negli USA."
            },
            "nb-downloads": {
                "textContent": "{[ plurale(nb) ]}"
            },
            "nb-downloads[one]": {
                "textContent": "1 download negli ultimi 30 giorni."
            },
            "nb-downloads[other]": {
                "textContent": "{{nb}} download negli ultimi 30 giorni."
            },
            "top-title": {
                "textContent": "Libreria del Progetto Gutenberg"
            },
            "sub-title": {
                "textContent": "Il primo produttore di ebooks gratuiti"
            },
            "table-previous": {
                "textContent": "Precedente"
            },
            ...
            "about-2": {
                "textContent": "Scegli fra file epub gratuiti, "
                               "file kindle gratuiti."
            },
            "about-3": {
                "textContent": "Scaricali o leggili online."
            },
            "about-4": {
                "textContent": "Noi forniamo ebook di alta qualità"
            },
            "about-5": {
        ...
        "ar": {
            ...
            "sort-popularity": {
                "textContent": "رتب الكتب بحسب الشعبية"
            },
            "sort-title": {
            ...
            "loading": {
                "textContent": "جار التحميل..."
            },
            "no-data": {
                "textContent": "لا توجد معلومات في الجدول"
            },
            "prev": {
                "textContent": "السابق"
            },
            ...
            "any-languages": {
                "textContent": "أختر قائمة"
            },
            "main-languages": {
                "textContent": "اللغات الأساسية"
            },
            "other-languages": {
                "textContent": "اللغات الأخرى"
            },
            "author-anonymous": {
                "textContent": "مجهول"
            },
            ...
            "license-pd": {
                "textContent": "مجال عام في الولايات المتحدة الأمريكية."
            },
            "nb-downloads": {
                "textContent": "{[ plural(nb) ]}"
            },
            "nb-downloads[one]": {
                "textContent": "تحميل واحد ضمن آخر 30 يوم."
            },
            "nb-downloads[other]": {
                "textContent": "{{nb}} تحميل ضمن آخر 30 يوم."
            },
            "top-title": {
                "textContent": "مشروع مكتبة Gutenberg"
            },
            "sub-title": {
                "textContent": "المصنع الأول للكتب الأكترونية المجانية"
            },
            "table-previous": {
                "textContent": "السابق"
            },
            ...
            "about-2": {
                "textContent": "أختر من ضمن كتب ال epub, "
                               "كتب kindle مجانية."
            },
            "about-3": {
                "textContent": "قم بتنزيلهم او قرائتهم عبر الأنترنت."
            },
            "about-4": {
                "textContent": "نحن لدينا كتب ألكترونية عالية الجودة"
            },
            "about-5": {
                "textContent": "كل كتبنا كانت مسبقا "
                               "منشورة من قبل ناشرين bona fide."
            },
            "about-6": {
        ...
        "nl": {
            ...
            "popularity": {
                "textContent": "Populariteit"
            },
            "sort": {
                "textContent": "Sorteer:"
            },
            "sort-popularity": {
                "textContent": "Sorteer boeken op populariteit"
            },
            "sort-title": {
            ...
            "loading": {
                "textContent": "Aan het laden..."
            },
            "no-data": {
                "textContent": "Geen gegevens beschikbaar in tabel"
            },
            "prev": {
                "textContent": "Vorige"
            },
            "next": {
                "textContent": "Volgende"
            },
            "language": {
                "textContent": "Taal"
            },
            "any-languages": {
                "textContent": "Selecteer de Catalogus"
            },
            "main-languages": {
                "textContent": "Belangrijkste talen"
            },
            "other-languages": {
                "textContent": "Andere talen"
            },
            "author-anonymous": {
                "textContent": "Anoniem"
            },
            "author-various": {
                "textContent": "Verschillende"
            },
            "license": {
                "textContent": "Licentie"
            },
            "license-pd": {
                "textContent": "Publiek domein in de VS."
            },
            "nb-downloads": {
                "textContent": "{[ plural(nb) ]}"
            },
            ...
            "top-title": {
                "textContent": "Project Gutenberg Bibliotheek"
            },
            "sub-title": {
                "textContent": "De eerste producent van gratis eboeken"
            },
            "table-previous": {
                "textContent": "Vorige"
            },
            ...
            "about-2": {
                "textContent": "Kies uit gratis epub boeken, "
                               "gratis kindle boeken."
            },
            "about-3": {
                "textContent": "Download ze of lees ze online."
            },
            "about-4": {
                "textContent": "Wij bieden eboeken van hoge kwaliteit"
            },
            "about-5": {
