    ...
    <v-container>
      <v-row>
        <v-col cols="12" md="8" class="mx-auto">
          ...
          <v-card class="mb-6">
            <v-card-text>
              ...
              <p class="text-body-1 mb-4">
                Choose among free epub books, free kindle books, and more.
          ...
          <v-row v-else-if="stats.totalBooks > 0 || stats.totalAuthors > 0 || stats.totalShelves > 0" class="mb-6">
            <v-col cols="12">
            ...
            <v-col cols="12" sm="4">
              <v-card variant="outlined" class="text-center pa-4">
                ...
                <div class="text-h4 font-weight-bold">{{ stats.totalAuthors.toLocaleString() }}</div>
            ...
            <v-col cols="12" sm="4">
              <v-card variant="outlined" class="text-center pa-4">
                ...
                <div class="text-h4 font-weight-bold">{{ stats.totalShelves.toLocaleString() }}</div>
          ...
          <v-card class="mb-6">
            ...
            <v-card-text>
              <p class="text-body-1 mb-4">
                This offline collection contains a curated selection of books from Project Gutenberg,
                the first and largest single collection of free electronic books.
              </p>
              <p class="text-body-1 mb-4">
                Project Gutenberg was founded in 1971 by Michael S. Hart and is the oldest digital library.
                The mission of Project Gutenberg is to encourage the creation and distribution of eBooks.
              </p>
              <p class="text-body-1">
                This collection is made available offline through Kiwix, allowing you to access these
                literary works without an internet connection.
              </p>
            </v-card-text>
          </v-card>
            ...
            <v-card-text>
              <v-list lines="one">
                ...
                >
                  ...
                  <v-list-item-subtitle>Visit the official Project Gutenberg website</v-list-item-subtitle>
                </v-list-item>
                <v-list-item
                ...
                >
                  ...
                  <v-list-item-subtitle>Learn more about Kiwix offline content</v-list-item-subtitle>
                </v-list-item>
              </v-list>
            </v-card-text>
          </v-card>
